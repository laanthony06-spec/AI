...
- [x] **Obsidian Web Clipper**（Chrome 扩展）
  - 用途：从网页剪藏资料到本地 vault。
  - 推荐模板：[[00.raw-materials/20.metadata/WebClipper模板-X推文.md]]

## 安装后检查

- [x] `.obsidian/community-plugins.json` 中能看到对应插件 ID。
- [x] 插件已 Enable。
- [x] 不把任何 Token / Cookie / AppSecret 写入插件说明笔记。
- [x] 安装后运行一次敏感扫描：[[00.raw-materials/90.processed/agent-knowledge-ops/sensitive-scan-report.md]]
