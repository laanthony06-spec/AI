...
2. 查阅相关系统与逻辑：[[30.areas/dsp-knowledge-base/README.md]]。
3. 按 [[30.areas/requirement-writing/01_SOP/需求单SOP提炼.md]] 形成结构。
4. 使用统一模板：[[30.areas/requirement-writing/01_SOP/需求单模板.md]]。
5. 用 [[30.areas/dsp-knowledge-base/07_ReviewAssistant/Requirement_Review_Checklist.md]] 做完整性检查。
6. 用 [[30.areas/requirement-writing/01_SOP/需求单工程化降AI风格规则.md]] 做最终语言收口。
7. 将确认过的新规则回写 DSP 知识库和案例库。
